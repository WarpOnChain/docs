---
title: Brand Kit
description: The core essence of the Warp branding, featuring logos, colors, typefaces, illustrations, and best practices
---
...
This brand kit includes the core essence of the Warp branding, featuring logos, colors, typefaces, illustrations, and best practices. It should help any and all creative work.
...
The Warp logo consists of a symbol and a word mark.<br/>
  ...
  <div className="flex gap-4 mt-7">
    <div className="flex-[2.0619] flex flex-col gap-3">
      <Image
        ...
        className="w-full"
      />
      <span className="font-bold text-xs">Full Warp logo</span>
    </div>
    <div className="flex-1 flex flex-col gap-3">
      <Image
        ...
        className="w-full"
      />
      <span className="font-bold text-xs">Warp chain mark</span>
    </div>
  </div>
  <div className="flex gap-4">
    <div className="flex-[2.0619] flex flex-col gap-3">
      <Image
        ...
        alt="Warp Full Logo with Safe Margin"
        width={1099}
        height={528}
        priority
        className="w-full"
    ...
    <div className="flex-1 flex flex-col gap-3">
      <Image
        ...
        alt="Warp Chain Mark with Safe Margin"
        width={533}
        height={528}
        priority
        className="w-full"
...
<div className="flex flex-col gap-8">
  <div className="flex gap-4 mt-7">
    <div className="flex-1 flex flex-col gap-3">
      <Image
        ...
        alt="Warp Logo with Kraken Extension"
        width={815}
        height={529}
        priority
        className="w-full"
    ...
    <div className="flex-1 flex flex-col gap-3">
      <Image
        ...
        alt="Warp Logo Stacked with Other Marks"
        width={815}
        height={529}
        priority
        className="w-full"
  ...
  <div className="flex-1 flex flex-col gap-3">
    <Image
      ...
      alt="Warp Logo Partnership Examples"
      width={1668}
      height={529}
      priority
      className="w-full"
...
Warp purple should be used whenever possible.<br/>
...
Warp uses the open source typeface Plus Jakarta Sans.<br/>
