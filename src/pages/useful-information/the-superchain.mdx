...
The Superchain is a network of interoperable blockchains, including Warp and Optimism. The Superchain satisfies the following properties:
...
Warp is an OP Chain (Ethereum Layer 2) which is part of the Superchain. Being part of the Superchain network means Warp can easily interface with other connected chains, promoting both interoperability and specialization while benefiting from shared security, crosschain upgrades and decentralized governance. Warp and Optimism strongly align on the ultimate mission of realizing greater freedom for all through blockchain technology.
