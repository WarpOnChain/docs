...
- The solution is to use an L3 architecture that commoditizes new chains - enabling efficient crosschain applications without introducing systemic risk and significant setup costs. In the future, we should be able to treat many L3 chain instances as a single unit, realizing the vision of the Superchain.
...
The Superchain is a network of interoperable blockchains, including Warp and Arbitrum. The Superchain satisfies the following properties:
...
## Warp and the Superchain

Warp is an OP Chain (Ethereum Layer 3) which is part of the Superchain. Being part of the Superchain network means Warp can easily interface with other connected chains, promoting both interoperability and specialization while benefiting from shared security, crosschain upgrades and decentralized governance. Warp and Arbitrum strongly align on the ultimate mission of realizing greater freedom for all through blockchain technology.
