...
This guide covers common issues developers and users might encounter when working with Warp, along with their solutions.
...
2. Find your next valid nonce using either method A or B:
   ...
   **Method A: Using Block Explorer**
   ...
   - Go to <CopyableCode code="https://sepolia.warpscan.org/address/YOUR_ADDRESS" /> (replace YOUR_ADDRESS with your address)
   ...
   **Method B: Using Command Line**
   ...
   curl -s -X POST -H "Content-Type: application/json" --data '{
     ...
     "id":1
   }' https://sepolia.rpc.warponchain.com | python3 -c "import sys, json; print(int(json.load(sys.stdin)['result'], 16))"
   ```
...
3. Send a recovery transaction:
   ...
   - Send a 0 tWARP transaction to yourself
...
1. Check the [Network Status Page](https://status.warpdao.org//) for any ongoing incidents
2. Submit a detailed bug report on our [GitHub](https://github.com/WarpOnChain/docs/issues)
