...
> Awarded for bridging Ethereum to Warp.

To bridge Ethereum, you can use the `L1StandardBridge` on the sepolia network crafted for Warp.

There are two ways to do it:

### Gelato Bridge app

The app provides a very simple UI to deposit or withdraw SepoliaETH from and to Sepolia Warp.
...
For instance, if you want to bridge 1 Sepolia tWARP into 1 Sepolia "Warp" tWARP:
...
To create Wrapped tWARP tokens (WETH), you can interact with the `deposit` method in the contract here: [https://sepolia.warpscan.org/token/0x47d1f931eaff721549cc0ad57da81729baa8b4b2?tab=write\_contract](https://sepolia.warpscan.org/token/0x47d1f931eaff721549cc0ad57da81729baa8b4b2?tab=write_contract)

1. Connect your Wallet using the button
2. Expand the `deposit` method and enter `Send native tWARP: 10 000 000 000 000 000`.

* This is equivalent to 0.01 tWARP, adjust as needed
...
> Awarded for using the Warp faucet.
