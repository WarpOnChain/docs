...
For instance, if you want to bridge 1 Sepolia ETH into 1 Sepolia "Warp" ETH:
...
To create Wrapped ETH tokens (WETH), you can interact with the `deposit` method in the contract here: [https://sepolia.warpscan.org/token/0x47d1f931eaff721549cc0ad57da81729baa8b4b2?tab=write\_contract](https://sepolia.warpscan.org/token/0x47d1f931eaff721549cc0ad57da81729baa8b4b2?tab=write_contract)
